    ...
    var body: some View {
        VStack {
            ...
            ZStack {
                ...
                ZStack { // At 60°
                    ZStack {
                        RadialGradient(gradient: Gradient(colors: [Color.purple, Color.purple]), center: .center, startRadius: 5, endRadius: 100)
                            .clipShape(Circle()).frame(width: 100, height: 100)
                            .offset(y: -41)
                    }
                    
                    ZStack {
                        RadialGradient(gradient: Gradient(colors: [Color.purple, Color.purple]), center: .center, startRadius: 5, endRadius: 90)
                            .clipShape(Circle()).frame(width: 100, height: 100)
                            .offset(y: 41)
                    }
                ...
                ZStack { // At 60*2°
                    ZStack {
                        RadialGradient(gradient: Gradient(colors: [Color.purple, Color.indigo]), center: .center, startRadius: 5, endRadius: 100)
                            .clipShape(Circle()).frame(width: 100, height: 100)
                            .offset(y: -41)
                    }
                    
                    ZStack {
                        RadialGradient(gradient: Gradient(colors: [Color.purple, Color.indigo]), center: .center, startRadius: 5, endRadius: 90)
                            .clipShape(Circle()).frame(width: 100, height: 100)
                            .offset(y: 41)
                    }
